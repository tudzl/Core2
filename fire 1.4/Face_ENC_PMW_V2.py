...
#PWM1 = machine.PWM(17, freq=10000, duty=70, timer=3)

#port C grove, pin 4 GPIO16 as second PWM output!
pin1 = machine.Pin(16, mode=machine.Pin.OUT, pull=machine.Pin.PULL_UP)
...
while True:
    ...
    if (press_cnt%2 == 0) :
        ...
        duty_cycle = duty_cycle_pre + ENC_delta*5
    else :
    ...
    if (duty_cycle == 0):
        ...
        label_info3.setText("Status: Max ON ")
    else:
        label_info3.setText("Status: PWM DIM")
