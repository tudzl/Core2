...
image_BG = M5Img("res/PWM_APP_BGV3C.png", x=0, y=0, parent=None)
...
switch_ON = M5Switch(x=200, y=24, w=70, h=30, bg_c=0xCCCCCC, color=0x0c9405, parent=None)
label_Akku = M5Label('Akku:', x=20, y=60, color=0x668303,  font=FONT_MONT_14, parent=None)
label_Akku_V = M5Label('', x=60, y=60, color=0x765303,  font=FONT_MONT_14, parent=None)
...
Freq_X10range = M5Checkbox(text='F_x10', x=210, y=60, text_c=0x362bd9, check_c=0xeb4234, font=FONT_MONT_14, parent=None)
