...
label_RTCinfo = M5Label('RTC', x=20, y=220, color=0xB0B0A0, font=FONT_MONT_16, parent=None)
...
print('Core2 bycycle Hall speed coupit V2.9B ')
...
while 1:
    ...
    if (Trig_cnt_pre<=Trig_cnt):#active input! 
        if (T_cycle2>0):
