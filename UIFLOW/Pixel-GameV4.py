...
Pixel_pos_init = 28
Pixel_pos =0
Pixel_target_index = 32 #objeect pixel's index(1-64)
Pixel_target_index_pre = 0
Pixel_row_num= 4
Pixel_col_num= 4
Pixel_brightness =30
...
screen_ON_OFF = 1
target_Pixel_mov_EN =0

def buttonA_wasPressed():
  # global params
  global target_Pixel_mov_EN
  target_Pixel_mov_EN=1-target_Pixel_mov_EN
  label1.set_text("Targt_Pixel_Mov!")
  pass
...
label0 = M5Label( "Pixel puzzle demo v4.00B",10, 6,0xFFFFFF, font=FONT_UNICODE_24, parent=None)
label_Hint = M5Label( "PortB-->Pixel",150, 60,0xF0BFF0, font=FONT_UNICODE_24, parent=None)
...
line0 = M5Line(x1=40, y1=90, x2=120, y2=90, color=0x003300, width=40, parent=None)
...
while True:
  ...
  #try:
      ...
      lcd.print("Acc_X:        ", 20, 60, 0xFFAAAA)
      lcd.print("Acc_Y:        ", 20, 80, 0xFFAAAA)
      lcd.print("Acc_Z:        ", 20, 100, 0xFFAAAA)
      ...
      if(1==target_Pixel_mov_EN):
          Pixel_target_index_pre=Pixel_target_index 
          Pixel_target_index = Pixel_target_index + int(random.randint(-2, 2))
          if Pixel_target_index>64:
             Pixel_target_index = 1
          pixel_update(Pixel_target_index,Pixel_target_index_pre)
