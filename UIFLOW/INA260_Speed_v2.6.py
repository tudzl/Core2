#INA260_Core2 demo V2.6  0162C86C
...
image_BG = M5Img("res/BMW_coupit BG2.png", x=0, y=0, parent=None)
Title = M5Label('INA260_Core2 Hall demo V2.5', x=20, y=5, color=0x2517de, font=FONT_MONT_14, parent=None)
...
label_sysinfo = M5Label('Sys_cnt', x=130, y=220, color=0xA0A0A0, font=FONT_MONT_12, parent=None)
label_Akkuinfo = M5Label('Akku', x=280, y=5, color=0x504000, font=FONT_MONT_12, parent=None)
...
while 1:
    ...
    if(T_delta>=T_interval):
       ...
       if (WheelSPD<1):
         ...
         rgb.setColor(4, 0xcc6600)
         rgb.setColor(9, 0xcc6600)
       else:
         rgb.setBrightness(30)
         rgb.setColor(5, 0xee2200)
         rgb.setColor(10, 0xee2200)
       if (WheelSPD>80):
         WheelSPD = 0
       if (PWM_EN):
          PWM0.resume()
       ...
       tmp_str ='speed:'+'%2.2F' % WheelSPD+ 'km/h'
       label_speed.set_text (tmp_str)
