...
print('GNSS_test based on DX-GP10 GNSS module(AT6558) V1.6C')
...
title0 = M5Label('GNSS tracker APP v1.6B', x=20,y=0,color=0x0FFFFF, font=FONT_UNICODE_24, parent=None)
