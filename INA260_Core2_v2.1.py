...
Title = M5Label('INA260_Core2 demo V1.1', x=20, y=5, color=0x2517de, font=FONT_MONT_14, parent=None)

label_vol = M5Label('Vbus_In:', x=20, y=40, color=0xEEEE00, font=FONT_MONT_16, parent=None)
label_Cur = M5Label('Current:', x=20, y=60, color=0xEE1E00, font=FONT_MONT_16, parent=None)
label_Hall = M5Label('Hall:', x=220, y=80, color=0xEE1E00, font=FONT_MONT_16, parent=None)
