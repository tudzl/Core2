...
neopixel_0 = unit.get(unit.NEOPIXEL, unit.PORTB, 64)
...
label0 = M5Label('label_X', x=40, y=41, color=0x000, font=FONT_MONT_14, parent=None)
label1 = M5Label('label_Y', x=40, y=72, color=0x000, font=FONT_MONT_14, parent=None)
label2 = M5Label('label_Y', x=40, y=100, color=0x000, font=FONT_MONT_14, parent=None)
label3 = M5Label('label3', x=40, y=129, color=0x000, font=FONT_MONT_14, parent=None)
label4 = M5Label('label4', x=39, y=158, color=0x000, font=FONT_MONT_14, parent=None)
label5 = M5Label('label5', x=187, y=128, color=0x000, font=FONT_MONT_14, parent=None)
label6 = M5Label('label6', x=186, y=151, color=0x000, font=FONT_MONT_14, parent=None)
label7 = M5Label('label7', x=186, y=176, color=0x000, font=FONT_MONT_14, parent=None)
